...
public class DocumentapiApplication {
	...
	// CsvSaver<TitleRelation> titleRelationSaver = new
	// CsvSaver<>("/home/todd/.documents/title_relations.csv",
	// 0L);
	// CsvSaver<TextRelation> textRelationSaver = new
	// CsvSaver<>("/home/todd/.documents/text_relations.csv", 0L);
	...
	// private Word getFromCache(Map<String, Word> cache, String stem, Set<Word>
	// newWords) {
	...
	// Set<String> textStems =
	// docService.getImperitiveStemsFromText(docService.getRealText(d));
